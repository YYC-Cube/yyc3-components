...
export function Badge({ children, ...props }: React.HTMLAttributes<HTMLDivElement> & { variant?: string }) {
  return React.createElement('div', props, children);
}

export function Button({ children, ...props }: React.ButtonHTMLAttributes<HTMLButtonElement> & { variant?: string; size?: string }) {
...
export function TabsTrigger({ children, ...props }: React.ButtonHTMLAttributes<HTMLButtonElement> & { value: string }) {
  return React.createElement('button', props, children);
}

export function TabsContent({ children, ...props }: React.HTMLAttributes<HTMLDivElement> & { value: string }) {
  return React.createElement('div', props, children);
}

export function Progress({ ...props }: React.HTMLAttributes<HTMLDivElement> & { value?: number }) {
